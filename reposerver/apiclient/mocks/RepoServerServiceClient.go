...
// ListPaths provides a mock function with given fields: ctx, in, opts
func (_m *RepoServerServiceClient) ListPaths(ctx context.Context, in *apiclient.ListPathsRequest, opts ...grpc.CallOption) (*apiclient.PathList, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *apiclient.PathList
	if rf, ok := ret.Get(0).(func(context.Context, *apiclient.ListPathsRequest, ...grpc.CallOption) *apiclient.PathList); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*apiclient.PathList)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *apiclient.ListPathsRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
